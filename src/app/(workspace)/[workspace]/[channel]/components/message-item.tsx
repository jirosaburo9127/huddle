            ...
            {onReact && (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-1 px-2 py-0.5 text-[11px] text-muted hover:text-accent border border-transparent hover:border-border/50 rounded transition-colors"
                >
            ...
            {isOwn && (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-2 py-0.5 text-[11px] text-muted hover:text-mention border border-transparent hover:border-border/50 rounded transition-colors"
                >
                  <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
