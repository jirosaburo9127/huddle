...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-white text-[#0f0f1a] antialiased">
      {/* ───────── ナビゲーション ───────── */}
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-[#ececec]">
      ...
      <section className="px-5 py-20 sm:py-28 border-b border-[#ececec]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white border-2 border-[#0f0f1a] rounded-3xl p-8 sm:p-12 shadow-xl shadow-[#0f0f1a]/10">
      ...
      {/* ───────── ⑧ 最終CTA ───────── */}
      <section className="px-5 py-24 sm:py-32 bg-[#0f0f1a] text-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl sm:text-5xl font-bold tracking-tight leading-tight mb-8">
            会議で決まったこと、
            <br />
          ...
          <Link
            href="/signup"
            className="inline-block bg-white text-[#0f0f1a] text-lg font-bold px-10 py-5 rounded-xl hover:bg-[#f5f5f7] transition-colors shadow-2xl"
          >
            無料ではじめる
          </Link>
      ...
      <div className="md:w-7/12">
        ...
        <div className="flex flex-wrap gap-2">
          {tags.map((t) => (
            <span
              key={t}
              className="text-xs bg-[#f5f5f7] border border-[#ececec] rounded-full px-3 py-1 text-[#55555c]"
            >
              #{t}
            </span>
          ))}
