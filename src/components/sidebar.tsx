        ...
        <div className="px-4 py-3 border-b border-border/50 bg-black text-white">
          ...
          >
            ...
            {hitorigotoChannel && (
              ...
              >
                {/* 吹き出し本体 */}
                <div className="relative bg-sidebar rounded-xl px-3 py-1.5 text-foreground text-sm font-semibold flex items-center gap-1.5 hover:bg-sidebar-hover transition-colors">
                  ...
                  独り言
                  {/* 吹き出しの三角（右向き） */}
                  <div className="absolute -right-1.5 top-1/2 -translate-y-1/2 w-3 h-3 bg-sidebar rotate-45" />
                </div>
