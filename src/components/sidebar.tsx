    ...
    <>
      ...
      >
        ...
        <div className="shrink-0" style={{ padding: "8px 12px 0" }}>
          ...
          {/* PC: カレンダー・ファイル・アルバム・(タスク)・保存へのリンク */}
          <div className="hidden lg:grid" style={{ gridTemplateColumns: workspaceSlug === "my-work" ? "1fr 1fr 1fr 1fr 1fr" : "1fr 1fr 1fr 1fr", gap: 2, padding: "2px 4px 6px" }}>
            {[
              ...
              ...(workspaceSlug === "my-work" ? [{ href: `/${workspaceSlug}/tasks`, label: "タスク", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" }] : []),
            ].map((item) => (
              <Link
                key={item.label}
                href={item.href}
...
function ChannelCategoryList({
  ...
  const colorMap = useMemo(() => {
    ...
    for (const c of categories) m.set(c.slug, c.color ?? null);
    return m;
  }, [categories]);
