        ...
        <div className="px-4 py-3 border-b border-border/50">
          ...
          >
            ...
            {hitorigotoChannel && (
              ...
              >
                {/* 吹き出し本体 */}
                <div className="relative bg-accent/15 border border-accent/25 rounded-xl px-3 py-1.5 text-accent text-sm font-semibold hover:bg-accent/25 transition-colors">
                  独り言
                  {/* 吹き出しの三角（右下に尻尾） */}
                  <div className="absolute -bottom-1.5 right-3 w-3 h-3 bg-accent/15 border-r border-b border-accent/25 rotate-45" />
                </div>
