-- 025 で owner/admin 限定にしていた rename を、メンバー全員解放に変更
-- ワークスペース名 → ワークスペースメンバーなら誰でも
-- チャンネル名 → チャンネルメンバー or ワークスペースメンバーなら誰でも
...
BEGIN
  ...
  -- チャンネルメンバー or ワークスペースメンバーなら変更可能
  IF NOT EXISTS (
